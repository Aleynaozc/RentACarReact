        ...
        <>
            <div className="howitworks__container col-lg-12">
                ...
                <div className='steps__container col-lg-8'>
                    <i class="fa-solid fa-location-dot howitwork_icon"></i>
                    <img className='howitwork_line1 ' src={require('../../../assets/images/work2.png')} />
                    <i class="fa-solid fa-calendar-plus howitwork_icon " style={{background: "linear-gradient(rgb(236, 201, 201),rgb(246, 215, 144))" ,color:'rgb(255, 255, 255)'}}></i>
                    <img className='howitwork_line' src={require('../../../assets/images/work.png')} />
                    <i class="fa-solid fa-calendar-check howitwork_icon"></i>
                </div>
